                    ...
                    <div key={trooper.id} className="flex flex-col gap-2 bg-gray-900 p-4 rounded-lg border border-gray-700">
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2">
                            ...
                            <SkillTooltip skill={trooper.skills[0]} t={t}>
                                <div className="relative group bg-gray-800 p-2 rounded border border-gray-600 hover:border-red-500 transition-colors cursor-help h-full">
                                    ...
                                    <div className="text-xs text-center text-gray-400 truncate">
                                        {trooper.skills[0] ? (t(`skill_${trooper.skills[0]?.id}_name`) !== `skill_${trooper.skills[0]?.id}_name` ? t(`skill_${trooper.skills[0]?.id}_name`) : trooper.skills[0]?.name) : '-'}
                                    </div>
                                </div>
                            </SkillTooltip>
                            ...
                            {trooper.skills[1] && (
                                <SkillTooltip skill={trooper.skills[1]} t={t}>
                                    <div className="relative group bg-gray-800 p-2 rounded border border-gray-600 hover:border-yellow-500 transition-colors cursor-help h-full">
